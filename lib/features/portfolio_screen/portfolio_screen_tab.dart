...
class PortfolioScreenTab extends StatelessWidget {
  const PortfolioScreenTab({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          SlideTransitionAnimation(
            uniqueKey: const Key('portfolio-tap-1'),
            child: SideHeadingText(text: 'PORTFOLIO', textSize: 0.03),
          ),
          SlideTransitionAnimation(
            uniqueKey: const Key('portfolio-tap-2'),
