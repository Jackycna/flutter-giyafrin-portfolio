...
class ContactScreenMob extends StatelessWidget {
  const ContactScreenMob({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(horizontal: w * 0.07, vertical: h * 0.1),
        child: Column(
          spacing: h * 0.05,
          mainAxisAlignment: .center,
          children: [
            SlideTransitionAnimation(
              uniqueKey: const Key('contact-mob-1'),
              child: AvailForOppur(),
            ),
            SlideTransitionAnimation(
              uniqueKey: const Key('contact-mob-2'),
            ...
            TransformScaleWidget(
              child: SlideTransitionAnimation(
                uniqueKey: const Key('contact-mob-3'),
            ...
            Row(
              ...
              children: [
                SlideTransitionAnimation(
                  uniqueKey: const Key('contact-mob-4'),
                  child: NameWidget(),
                ),
                SlideTransitionAnimation(
                  uniqueKey: const Key('contact-mob-5'),
                  child: Row(
                    spacing: w * 0.02,
                    children: [
                      TransformScaleWidget(
